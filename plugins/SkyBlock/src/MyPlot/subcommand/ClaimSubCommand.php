...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
			...
			$player->getInventory()->addItem(Item::get(8, 0, 3));
			$player->getInventory()->addItem(Item::get(85, 0, 3));
			$player->getInventory()->addItem(Item::get(278, 0, 1));
			$player->getInventory()->addItem(Item::get(54, 0, 2));
            $player->getInventory()->addItem(Item::get(410, 0, 2));
            $sender->sendMessage("§aĐã Thêm§b Nước§a Và§6 Hàng Rào§a Vào Kho Đồ Của Bạn!");
        } else {
