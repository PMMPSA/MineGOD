...
class essentialsTP extends PluginBase  implements CommandExecutor, Listener {
    ...
    public function onEnable(){
        ...
        $this->create_db();
        $this->getLogger()->info(TextFormat::GREEN."[INFO] Đang Tải [".TextFormat::GOLD."config.yml".TextFormat::GREEN."]....");
        $this->tpa_cooldown = time() - $this->config->get("tpa-here-cooldown");
        $this->getLogger()->info(TextFormat::GREEN."[INFO] Đang Tải [".TextFormat::GOLD."config.yml".TextFormat::GREEN."] ... Xong");
        $this->getLogger()->info(TextFormat::GREEN."EssentialsTP Đã Tải Xong");
    ...
    public function onDisable(){
        $this->prepare->close();
        $this->getLogger()->info("EssentialsTP Đã Bị Vô Hiệu Hóa");
    }
